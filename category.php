                        ...
                        <div class="col-8 mx-auto">
                            <form action="category_data.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-8 mx-auto my-4">
                                    <input type="file" class="form-control" required name="image" id="image" placeholder="Ex. Italian,Punjabi...">
                                    <div class="validate"></div>
                                </div>
                                        ...
                                        <tr class="align-middle">
                                            ...
                                            <td>
                                                <div class='row col-10 mx-auto'>
                                                    ...
                                                    <!-- <a href="student_update.php?id=<?=$rec['id']?>" class='btn btn-success'>Update</a> -->
                                                    </div>
                                                    <div class='col-3 mx-auto'>
                                                        ...
                                                        <div class="row">
                                                            <div class=" mx-auto">
                                                                <form action="category_data.php" method="post" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="col-lg-8 mx-auto">
                                                                        <input type="name" class="form-control" value="<?=$rec['name']; ?>" required name="name" id="name" placeholder="Ex. Italian,Punjabi...">
                                                                        <div class="validate"></div>
                                                                    </div>
                                                                    <div class="col-lg-8 mx-auto my-4">
